export const demoText: string = `# Lyrata Демо

Для переключения выделения используйте стрелки на клавиатуре. Текст будет сам плавно перемещаться к цетру экрана, чтобы удобнее было читать. Теперь немного о самом приложении: в Lyrata пользователь, добавив свой текст, читает только выделенную часть текста и сам переносит выделение вперёд/назад нажатиями кнопок. Чтобы обратно выйти в главное меню наведитесь в левый верхний угол, там появится кнопка "назад". Музыка пока в разработке. На странице с выбором текста вы можете вставить любой свой текст, который хотите прочитать, либо загрузить свои файлы формата md или html. Почти все надписи на всех страницах кроме этой кликабельные.

Для опробывания визуальной части чтения в приложении можете прочитать предложенный текст А. П. Чехова, "Ванька":
